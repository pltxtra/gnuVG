...
namespace gnuVG {
	...
	public:
		...
		MaskLayer(Context* ctx, VGint width, VGint height);
		virtual ~MaskLayer();

		/* OpenVG equivalent API - MaskLayer manipulation */
		void vgFillMaskLayer(VGint x, VGint y, VGint width, VGint height, VGfloat value);
		void vgCopyMask(VGint dx, VGint dy,
				VGint sx, VGint sy,
